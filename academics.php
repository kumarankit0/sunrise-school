...
<div class="flex flex-col w-full">
  ...
  <section class="relative w-full min-h-[80vh] lg:min-h-[85vh] py-20 lg:py-28 bg-primary text-on-primary px-6 lg:px-12 overflow-hidden flex items-center justify-center text-center">
    <div class="absolute inset-0 opacity-65 bg-cover bg-center pointer-events-none" style="background-image: url('<?= school_img('exhibition.webp') ?>')"></div>
    ...
    <div class="max-w-6xl w-full mx-auto relative z-10 flex flex-col items-center text-center gap-6">
      <span class="font-eyebrow text-eyebrow text-gold-light uppercase tracking-widest bg-black/40 border border-[#C9A24B]/50 px-5 py-2 rounded-full font-bold shadow-md">Academic Excellence</span>
      <h1 class="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-headline-lg text-white w-full max-w-5xl tracking-tight leading-[1.15] drop-shadow-md">Rigorous HBSC Curriculum Designed for Success</h1>
      <p class="text-lg sm:text-xl md:text-2xl text-surface-cream/95 w-full max-w-4xl leading-relaxed drop-shadow">Discover an enriching academic framework from Pre-Primary to Class 12, fostering analytical thinking, practical lab experimentation, moral values, and board examination distinction.</p>
  ...
  <section class="bg-surface-container-high py-8 sm:py-12 px-4 sm:px-6 lg:px-12">
    <div class="max-w-7xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-8 text-center">
      <div class="flex flex-col items-center p-2 sm:p-0">
        <span class="font-display-hero text-2xl sm:text-3xl lg:text-4xl text-primary font-bold">100%</span>
        <span class="font-eyebrow text-[10px] sm:text-xs md:text-sm text-on-surface-variant uppercase mt-1 sm:mt-2 font-bold leading-tight">HBSC Pass Record</span>
      </div>
      <div class="flex flex-col items-center p-2 sm:p-0">
        <span class="font-display-hero text-2xl sm:text-3xl lg:text-4xl text-primary font-bold">1:15</span>
      ...
      <div class="flex flex-col items-center p-2 sm:p-0">
        <span class="font-display-hero text-2xl sm:text-3xl lg:text-4xl text-primary font-bold whitespace-nowrap">3 Streams</span>
        <span class="font-eyebrow text-[10px] sm:text-xs md:text-sm text-on-surface-variant uppercase mt-1 sm:mt-2 font-bold leading-tight">Science, Commerce &amp; Arts</span>
      </div>
      <div class="flex flex-col items-center p-2 sm:p-0">
        <span class="font-display-hero text-2xl sm:text-3xl lg:text-4xl text-primary font-bold">Modern</span>
        <span class="font-eyebrow text-[10px] sm:text-xs md:text-sm text-on-surface-variant uppercase mt-1 sm:mt-2 font-bold leading-tight">Labs &amp; Smart Classes</span>
      </div>
    </div>
  </section>
  ...
  <section class="py-24 px-6 lg:px-12 max-w-7xl mx-auto w-full" id="curriculum-levels">
    <div class="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6">
      <div>
        <span class="font-eyebrow text-eyebrow text-[#C9A24B] uppercase tracking-widest font-bold">Academic Stages</span>
        <h2 class="font-headline-lg text-headline-lg text-primary mt-2">Curriculum Stages by Level</h2>
      </div>
      <p class="font-body-md text-on-surface-variant max-w-md">Our progressive learning architecture builds conceptual clarity, self-confidence, and critical inquiry from early years to Class 12.</p>
    </div>
  ...
  <section class="py-24 px-6 lg:px-12 max-w-7xl mx-auto w-full bg-surface-container-low" id="streams">
    <div class="text-center max-w-2xl mx-auto mb-16">
      <span class="font-eyebrow text-eyebrow text-[#C9A24B] uppercase tracking-widest font-bold">Class 11 &amp; 12 Streams</span>
      <h2 class="font-headline-lg text-headline-lg text-primary mt-2">Senior Secondary Academic Streams</h2>
      <p class="font-body-md text-on-surface-variant mt-3">Tailored academic pathways equipping students for HBSC board excellence and leading university admissions.</p>
    </div>
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
      ...
      <div class="bg-surface-pure rounded-2xl p-8 border border-border-warm shadow-sm flex flex-col justify-between relative overflow-hidden">
        ...
        <div>
          ...
          <h3 class="font-headline-md text-headline-md text-primary mb-3">Science (Medical &amp; Non-Medical)</h3>
          <p class="font-body-sm text-on-surface-variant mb-6">Equipped with state-of-the-art physics, chemistry, biology, and computer science laboratories for in-depth conceptual and practical learning.</p>
          <div class="space-y-3">
      ...
      <div class="bg-surface-pure rounded-2xl p-8 border border-border-warm shadow-sm flex flex-col justify-between relative overflow-hidden">
        ...
        <div>
          ...
          <h3 class="font-headline-md text-headline-md text-primary mb-3">Commerce</h3>
          <p class="font-body-sm text-on-surface-variant mb-6">Comprehensive economic, accounting, and business studies designed for careers in banking, finance, CA, and entrepreneurship.</p>
          <div class="space-y-3">
            <div class="text-body-sm text-on-surface font-bold">Core Subjects:</div>
            <ul class="space-y-2 text-body-sm text-on-surface-variant">
      ...
      <div class="bg-surface-pure rounded-2xl p-8 border border-border-warm shadow-sm flex flex-col justify-between relative overflow-hidden">
        ...
        <div>
          ...
          <h3 class="font-headline-md text-headline-md text-primary mb-3">Arts &amp; Humanities</h3>
          <p class="font-body-sm text-on-surface-variant mb-6">Deep exploration of history, political science, geography, literature, and social sciences for future administrative and legal leaders.</p>
          <div class="space-y-3">
            <div class="text-body-sm text-on-surface font-bold">Core Subjects:</div>
            <ul class="space-y-2 text-body-sm text-on-surface-variant">
  ...
  <section class="py-24 px-6 lg:px-12 max-w-7xl mx-auto w-full">
    <div class="text-center max-w-2xl mx-auto mb-16">
      <span class="font-eyebrow text-eyebrow text-[#C9A24B] uppercase tracking-widest font-bold">Pedagogical Approach</span>
      <h2 class="font-headline-lg text-headline-lg text-primary mt-2">How We Teach at Sun Rise</h2>
      <p class="font-body-md text-on-surface-variant mt-3">Combining traditional teacher mentorship with modern smart-class technology and experimental learning.</p>
    </div>
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
      <div class="bg-surface-pure p-8 rounded-2xl shadow-sm border border-border-warm flex flex-col justify-between hover:-translate-y-1 transition-transform">
        <div>
          ...
          <h3 class="font-headline-sm text-headline-sm text-primary mb-3 font-bold">Concept Clarity</h3>
          <p class="font-body-sm text-on-surface-variant">Focus on thorough understanding of NCERT fundamentals before moving to advanced problem solving.</p>
        </div>
      ...
      <div class="bg-surface-pure p-8 rounded-2xl shadow-sm border border-border-warm flex flex-col justify-between hover:-translate-y-1 transition-transform">
        <div>
          ...
          <h3 class="font-headline-sm text-headline-sm text-primary mb-3 font-bold">Practical Labs</h3>
          <p class="font-body-sm text-on-surface-variant">Hands-on experiments in physics, chemistry, biology, and computer science reinforce classroom theory.</p>
        </div>
      ...
      <div class="bg-surface-pure p-8 rounded-2xl shadow-sm border border-border-warm flex flex-col justify-between hover:-translate-y-1 transition-transform">
        <div>
          ...
          <h3 class="font-headline-sm text-headline-sm text-primary mb-3 font-bold">Regular Testing</h3>
          <p class="font-body-sm text-on-surface-variant">Periodic unit tests, term exams, and mock board tests ensure continuous assessment and revision.</p>
        </div>
      ...
      <div class="bg-surface-pure p-8 rounded-2xl shadow-sm border border-border-warm flex flex-col justify-between hover:-translate-y-1 transition-transform">
        <div>
          ...
          <h3 class="font-headline-sm text-headline-sm text-primary mb-3 font-bold">Individual Care</h3>
          <p class="font-body-sm text-on-surface-variant">Remedial classes for students needing extra help and personalized attention for every scholar.</p>
        </div>
