...
<span class="font-bold text-emerald-700 bg-emerald-100 px-2 py-0.5 rounded text-[11px] uppercase">Active Now</span>
</div>
</div>
</div>
</div>
...
<span class="font-label-md text-label-md text-primary font-bold truncate">Class &amp; Stream Choice</span>
</div>
</div>
<!-- Step 2 -->
<div class="flex items-center gap-3">
...
<span class="font-label-md text-label-md text-primary font-bold truncate">Student Profile Info</span>
</div>
</div>
<!-- Step 3 -->
...
<span class="font-label-md text-label-md text-on-surface-variant font-semibold truncate">Transit &amp; Documents</span>
</div>
</div>
<!-- Step 4 -->
<div class="flex items-center gap-3 opacity-75">
...
<span class="font-label-md text-label-md text-on-surface-variant font-semibold truncate">Fee Review &amp; Checkout</span>
</div>
</div>
</div>
</div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6" id="class-cards-grid">
      ...
      <div class="grade-card group relative bg-surface-pure rounded-xl p-6 shadow-md transition-all duration-300 flex flex-col justify-between cursor-pointer ring-2 ring-[#C9A24B]" data-grade-id="xi-nonmed" data-grade-name="Class 11 - Science (Non-Medical)" data-group="senior" data-reg-fee="300" data-seats="12" data-tuition-fee="1000">
        ...
        <div class="flex flex-col gap-3">
          ...
          <div>
            <h3 class="font-headline-sm text-headline-sm text-primary group-hover:text-secondary transition-colors">Class XI – Science (Non-Med)</h3>
            <p class="font-body-sm text-body-sm text-on-surface-variant mt-1">Physics, Chemistry, Math + Comp. Science / Physical Edu with NDA &amp; JEE Foundation Track.</p>
          </div>
          <div class="pt-3 flex flex-col gap-1.5 text-body-sm text-text-charcoal bg-surface-container-low/60 p-3 rounded-lg">
            <div class="flex justify-between">
              ...
              <span class="font-bold">15 - 17 Years</span>
            </div>
            <div class="flex justify-between">
              <span class="text-on-surface-variant">Monthly Fee:</span>
              <span class="font-bold text-primary">₹1,000 / Month</span>
            </div>
            <div class="flex justify-between">
              <span class="text-on-surface-variant">Reg. Form Fee:</span>
              <span class="font-bold text-secondary">₹300</span>
            </div>
          </div>
        </div>
      ...
      <div class="grade-card group relative bg-surface-pure rounded-xl p-6 shadow-sm hover:shadow-md transition-all duration-300 flex flex-col justify-between cursor-pointer" data-grade-id="xi-med" data-grade-name="Class 11 - Science (Medical)" data-group="senior" data-reg-fee="300" data-seats="8" data-tuition-fee="1000">
        <div class="flex flex-col gap-3">
          ...
          <div>
            <h3 class="font-headline-sm text-headline-sm text-primary group-hover:text-secondary transition-colors">Class XI – Science (Medical)</h3>
            <p class="font-body-sm text-body-sm text-on-surface-variant mt-1">Physics, Chemistry, Biology + Biotech/IP with dedicated NEET coaching orientation lab.</p>
          </div>
          <div class="pt-3 flex flex-col gap-1.5 text-body-sm text-text-charcoal bg-surface-container-low/60 p-3 rounded-lg">
            <div class="flex justify-between">
              <span class="text-on-surface-variant">Age Criteria:</span>
      ...
      <div class="grade-card group relative bg-surface-pure rounded-xl p-6 shadow-sm hover:shadow-md transition-all duration-300 flex flex-col justify-between cursor-pointer" data-grade-id="xi-comm" data-grade-name="Class 11 - Commerce &amp; Humanities" data-group="senior" data-reg-fee="300" data-seats="22" data-tuition-fee="950">
        <div class="flex flex-col gap-3">
          ...
          <div>
            <h3 class="font-headline-sm text-headline-sm text-primary group-hover:text-secondary transition-colors">Class XI – Commerce &amp; Arts</h3>
            <p class="font-body-sm text-body-sm text-on-surface-variant mt-1">Accountancy, Business Studies, Economics, Pol. Science, Geography &amp; Applied Mathematics.</p>
          </div>
          <div class="pt-3 flex flex-col gap-1.5 text-body-sm text-text-charcoal bg-surface-container-low/60 p-3 rounded-lg">
            <div class="flex justify-between">
              <span class="text-on-surface-variant">Age Criteria:</span>
            ...
            <div class="flex justify-between">
              <span class="text-on-surface-variant">Monthly Fee:</span>
              <span class="font-bold text-primary">₹950 / Month</span>
            </div>
            <div class="flex justify-between">
              <span class="text-on-surface-variant">Reg. Form Fee:</span>
              <span class="font-bold text-secondary">₹300</span>
      ...
      <div class="grade-card group relative bg-surface-pure rounded-xl p-6 shadow-sm hover:shadow-md transition-all duration-300 flex flex-col justify-between cursor-pointer" data-grade-id="ix-x" data-grade-name="Class 9 &amp; 10 (Secondary High)" data-group="secondary" data-reg-fee="250" data-seats="16" data-tuition-fee="900">
        <div class="flex flex-col gap-3">
          ...
          <div class="pt-3 flex flex-col gap-1.5 text-body-sm text-text-charcoal bg-surface-container-low/60 p-3 rounded-lg">
            <div class="flex justify-between">
              <span class="text-on-surface-variant">Age Criteria:</span>
              <span class="font-bold">13 - 15 Years</span>
            </div>
            <div class="flex justify-between">
              <span class="text-on-surface-variant">Monthly Fee:</span>
              <span class="font-bold text-primary">₹900 / Month</span>
            </div>
            <div class="flex justify-between">
              <span class="text-on-surface-variant">Reg. Form Fee:</span>
      ...
      <div class="grade-card group relative bg-surface-pure rounded-xl p-6 shadow-sm hover:shadow-md transition-all duration-300 flex flex-col justify-between cursor-pointer" data-grade-id="vi-viii" data-grade-name="Class 6 to 8 (Middle Wing)" data-group="middle" data-reg-fee="200" data-seats="19" data-tuition-fee="800">
        <div class="flex flex-col gap-3">
          <div class="flex justify-between items-start">
            <span class="px-2.5 py-1 bg-surface-cream text-primary rounded font-label-sm font-bold text-xs uppercase">Middle Wing</span>
            <span class="text-xs font-bold text-emerald-800 bg-emerald-50 px-2 py-0.5 rounded">19 Seats Available</span>
          </div>
          <div>
            <h3 class="font-headline-sm text-headline-sm text-primary group-hover:text-secondary transition-colors">Class VI – VIII (Middle Wing)</h3>
            <p class="font-body-sm text-body-sm text-on-surface-variant mt-1">Foundational STEM concepts, computer coding, Hindi &amp; English debate, and agricultural science basics.</p>
          </div>
          <div class="pt-3 flex flex-col gap-1.5 text-body-sm text-text-charcoal bg-surface-container-low/60 p-3 rounded-lg">
            <div class="flex justify-between">
              <span class="text-on-surface-variant">Age Criteria:</span>
              <span class="font-bold">10 - 13 Years</span>
            </div>
            <div class="flex justify-between">
              <span class="text-on-surface-variant">Monthly Fee:</span>
              <span class="font-bold text-primary">₹800 / Month</span>
            </div>
            <div class="flex justify-between">
              <span class="text-on-surface-variant">Reg. Form Fee:</span>
      ...
      <div class="grade-card group relative bg-surface-pure rounded-xl p-6 shadow-sm hover:shadow-md transition-all duration-300 flex flex-col justify-between cursor-pointer" data-grade-id="i-v" data-grade-name="Class 1 to 5 (Primary School)" data-group="middle" data-reg-fee="200" data-seats="25" data-tuition-fee="700">
        <div class="flex flex-col gap-3">
          <div class="flex justify-between items-start">
            <span class="px-2.5 py-1 bg-surface-cream text-primary rounded font-label-sm font-bold text-xs uppercase">Primary</span>
            <span class="text-xs font-bold text-emerald-800 bg-emerald-50 px-2 py-0.5 rounded">25 Seats Available</span>
          </div>
          <div>
            <h3 class="font-headline-sm text-headline-sm text-primary group-hover:text-secondary transition-colors">Class I – V (Primary School)</h3>
            <p class="font-body-sm text-body-sm text-on-surface-variant mt-1">Activity-based learning, phonetics, environmental studies, performing arts, and physical fitness.</p>
          </div>
          <div class="pt-3 flex flex-col gap-1.5 text-body-sm text-text-charcoal bg-surface-container-low/60 p-3 rounded-lg">
            <div class="flex justify-between">
              <span class="text-on-surface-variant">Age Criteria:</span>
              <span class="font-bold">5 - 10 Years</span>
            </div>
            <div class="flex justify-between">
              <span class="text-on-surface-variant">Monthly Fee:</span>
              <span class="font-bold text-primary">₹700 / Month</span>
            </div>
            <div class="flex justify-between">
              <span class="text-on-surface-variant">Reg. Form Fee:</span>
              <span class="font-bold text-secondary">₹200</span>
      ...
      <div class="grade-card group relative bg-surface-pure rounded-xl p-6 shadow-sm hover:shadow-md transition-all duration-300 flex flex-col justify-between cursor-pointer" data-grade-id="pre-kg" data-grade-name="Kindergarten (Nursery/LKG/UKG)" data-group="preprimary" data-reg-fee="200" data-seats="30" data-tuition-fee="600">
        <div class="flex flex-col gap-3">
          <div class="flex justify-between items-start">
            <span class="px-2.5 py-1 bg-surface-cream text-primary rounded font-label-sm font-bold text-xs uppercase">Early Years</span>
            <span class="text-xs font-bold text-emerald-800 bg-emerald-50 px-2 py-0.5 rounded">30 Seats Available</span>
          </div>
          <div>
            <h3 class="font-headline-sm text-headline-sm text-primary group-hover:text-secondary transition-colors">Pre-Primary (Nursery, KG)</h3>
            <p class="font-body-sm text-body-sm text-on-surface-variant mt-1">Montessori-inspired play gym, sensorimotor training, creative storytelling &amp; air-conditioned playzones.</p>
          </div>
          <div class="pt-3 flex flex-col gap-1.5 text-body-sm text-text-charcoal bg-surface-container-low/60 p-3 rounded-lg">
            <div class="flex justify-between">
              <span class="text-on-surface-variant">Age Criteria:</span>
              <span class="font-bold">3 - 5 Years</span>
            </div>
            <div class="flex justify-between">
              <span class="text-on-surface-variant">Monthly Fee:</span>
              <span class="font-bold text-primary">₹600 / Month</span>
            </div>
            <div class="flex justify-between">
              <span class="text-on-surface-variant">Reg. Form Fee:</span>
              <span class="font-bold text-secondary">₹200</span>
      ...
      <div class="grade-card group relative bg-surface-pure rounded-xl p-6 shadow-sm hover:shadow-md transition-all duration-300 flex flex-col justify-between cursor-pointer" data-grade-id="xii-transfer" data-grade-name="Class 12 - Board Transfer Entry" data-group="senior" data-reg-fee="350" data-seats="5" data-tuition-fee="1000">
        <div class="flex flex-col gap-3">
          ...
          <div class="pt-3 flex flex-col gap-1.5 text-body-sm text-text-charcoal bg-surface-container-low/60 p-3 rounded-lg">
            <div class="flex justify-between">
              <span class="text-on-surface-variant">Age Criteria:</span>
              <span class="font-bold">16 - 18 Years</span>
            </div>
            <div class="flex justify-between">
              <span class="text-on-surface-variant">Monthly Fee:</span>
              <span class="font-bold text-primary">₹1,000 / Month</span>
            ...
            <div class="flex justify-between">
              <span class="text-on-surface-variant">Reg. Form Fee:</span>
              <span class="font-bold text-secondary">₹350</span>
            </div>
          </div>
        </div>
        <div class="mt-5 pt-3 flex items-center justify-between">
...
<div>
<h3 class="font-headline-sm text-headline-sm text-primary">Residence &amp; Daily School Bus Facility</h3>
<p class="font-body-sm text-body-sm text-on-surface-variant">Fleet covering 35+ villages in Hisar and neighboring rural belts</p>
</div>
</div>
<div class="grid grid-cols-1 md:grid-cols-2 gap-5">
...
<div>
<span class="font-label-md text-label-md text-primary font-bold block">Route 4: Dobhi Village &amp; Balsamand</span>
<span class="text-body-sm text-on-surface-variant">Pick-up at Main Stand / Doorway (₹300/month)</span>
</div>
</div>
...
<div>
<span class="font-label-md text-label-md text-primary font-bold block">1. Student Birth Certificate / 10th TC</span>
<span class="text-body-sm text-on-surface-variant">Official date of birth validation</span>
</div>
...
<div class="flex items-start justify-between">
<div>
<span class="font-label-md text-label-md text-primary font-bold block">2. Class 10 / Prior Marksheet</span>
<span class="text-body-sm text-on-surface-variant">Provisional web copy accepted</span>
</div>
<span class="material-symbols-outlined text-emerald-600">check_circle</span>
</div>
<div class="flex items-center justify-between text-label-sm">
...
<div class="flex items-start justify-between">
<div>
<span class="font-label-md text-label-md text-primary font-bold block">3. Student &amp; Parent Aadhaar Card</span>
<span class="text-body-sm text-on-surface-variant">Residence proof &amp; biometric ID</span>
</div>
...
<div class="flex items-start justify-between">
<div>
<span class="font-label-md text-label-md text-primary font-bold block">4. Passport Sized Photos (4)</span>
<span class="text-body-sm text-on-surface-variant">Formal school uniform or plain bg</span>
</div>
...
<div>
<span class="font-eyebrow text-eyebrow text-secondary-fixed uppercase tracking-wider">Session 2026–27 Enrollment</span>
<h3 class="font-headline-sm text-headline-sm text-on-primary mt-1">Live Admission Checkout</h3>
</div>
...
<div>
<span class="font-bold text-secondary text-xs uppercase block">Special Welcome Discount</span>
<span class="text-[11px] text-on-surface-variant">₹200 concession applied on 1st month</span>
</div>
</div>
<span class="font-bold text-secondary">-₹200</span>
</div>
...
<span class="text-sm font-bold text-secondary mt-0.5" id="tier-token-amount">₹500</span>
...
<span class="font-bold text-text-charcoal">Scan via GPay, PhonePe, Paytm or BHIM</span>
<span class="">VPA: sunrise.dobhi@icici</span>
...
<span class="">Proceed to Secure Checkout &amp; Reserve Seat →</span>
</button>
...
<p class="text-[11px] text-outline leading-tight">
                * Note: If entrance assessment is not cleared, 100% tuition and seat advance is refunded within 7 working days to source bank.
              </p>
</div>
</div>
</div>
  ...
  <div class="max-w-7xl mx-auto flex flex-col gap-8">
    <div class="flex flex-col md:flex-row md:items-end justify-between gap-4">
      ...
      <button class="inline-flex items-center gap-2 bg-surface-pure hover:bg-surface-cream text-primary px-5 py-3 rounded-lg shadow-sm font-label-md font-bold transition-colors self-start md:self-auto">
        <span class="material-symbols-outlined text-[#C9A24B]">download</span> Download Official Fee Prospectus PDF
      </button>
    </div>
      ...
      <table class="w-full text-left border-collapse">
        ...
        <tbody class="divide-y-0 text-body-md text-text-charcoal font-medium">
          <tr class="hover:bg-surface-container-low transition-colors">
            ...
            <td class="py-4 px-6 text-on-surface-variant">3 to 5 Years</td>
            <td class="py-4 px-6">₹200</td>
            <td class="py-4 px-6 font-bold text-primary">₹600 / mo</td>
            <td class="py-4 px-6">₹400 / yr</td>
            <td class="py-4 px-6 text-right font-bold text-primary">₹7,800</td>
          </tr>
          <tr class="bg-surface-container-low/40 hover:bg-surface-container-low transition-colors">
            ...
            <td class="py-4 px-6 text-on-surface-variant">5 to 10 Years</td>
            <td class="py-4 px-6">₹200</td>
            <td class="py-4 px-6 font-bold text-primary">₹700 / mo</td>
            <td class="py-4 px-6">₹500 / yr</td>
            <td class="py-4 px-6 text-right font-bold text-primary">₹9,100</td>
          </tr>
          <tr class="hover:bg-surface-container-low transition-colors">
            <td class="py-4 px-6 font-bold text-primary flex items-center gap-2">
              <span class="w-2 h-2 rounded-full bg-secondary"></span> Middle School (Class 6 to 8)
            </td>
            <td class="py-4 px-6 text-on-surface-variant">10 to 13 Years</td>
            <td class="py-4 px-6">₹200</td>
            <td class="py-4 px-6 font-bold text-primary">₹800 / mo</td>
            <td class="py-4 px-6">₹600 / yr</td>
            <td class="py-4 px-6 text-right font-bold text-primary">₹10,400</td>
          </tr>
          <tr class="bg-surface-container-low/40 hover:bg-surface-container-low transition-colors">
            <td class="py-4 px-6 font-bold text-primary flex items-center gap-2">
              <span class="w-2 h-2 rounded-full bg-[#C9A24B]"></span> Secondary (Class 9 &amp; 10)
            </td>
            <td class="py-4 px-6 text-on-surface-variant">13 to 15 Years</td>
            <td class="py-4 px-6">₹250</td>
            <td class="py-4 px-6 font-bold text-primary">₹900 / mo</td>
            <td class="py-4 px-6">₹800 / yr</td>
            <td class="py-4 px-6 text-right font-bold text-primary">₹11,850</td>
          </tr>
          <tr class="hover:bg-surface-container-low transition-colors bg-surface-cream/50">
            ...
            <td class="py-4 px-6 text-on-surface-variant">15 to 17 Years</td>
            <td class="py-4 px-6 font-bold text-secondary">₹300</td>
            <td class="py-4 px-6 font-bold text-primary">₹1,000 / mo</td>
            <td class="py-4 px-6">₹1,000 / yr</td>
            <td class="py-4 px-6 text-right font-bold text-secondary">₹13,300</td>
          </tr>
          <tr class="bg-surface-container-low/40 hover:bg-surface-container-low transition-colors">
            <td class="py-4 px-6 font-bold text-primary flex items-center gap-2">
            ...
            <td class="py-4 px-6 font-bold text-primary">₹950 / mo</td>
            <td class="py-4 px-6">₹800 / yr</td>
            <td class="py-4 px-6 text-right font-bold text-primary">₹12,500</td>
          </tr>
        </tbody>
      </table>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
      ...
      <div class="p-4 bg-surface-pure rounded-lg shadow-sm flex items-start gap-3">
        ...
        <div class="text-xs">
          <span class="font-bold text-primary block">Sibling Concession Scheme</span>
          <span class="text-on-surface-variant">15% discount on monthly tuition fees for the second biological child studying concurrently in school.</span>
        </div>
      </div>
      <div class="p-4 bg-surface-pure rounded-lg shadow-sm flex items-start gap-3">
        <span class="material-symbols-outlined text-[#C9A24B] text-[24px]">workspace_premium</span>
        <div class="text-xs">
          <span class="font-bold text-primary block">Defence &amp; Police Personnel</span>
          <span class="text-on-surface-variant">Special educational welfare concession of ₹300 / month for children of armed service personnel.</span>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
    ...
    <div class="lg:col-span-5 flex flex-col gap-6">
      ...
      <div class="bg-surface-pure rounded-xl p-6 shadow-sm flex flex-col gap-4">
        <div class="flex items-start gap-3">
          ...
          <div class="text-body-sm">
            <span class="font-bold text-primary block">Original Transfer Certificate (TC)</span>
            <span class="text-on-surface-variant">Countersigned by District Education Officer (if transferring from other state board).</span>
          </div>
        </div>
        <div class="flex items-start gap-3">
          <span class="material-symbols-outlined text-secondary text-[22px] mt-0.5">task_alt</span>
          <div class="text-body-sm">
            <span class="font-bold text-primary block">Municipal Birth Certificate</span>
            <span class="text-on-surface-variant">Mandatory for Nursery to Class 1 admissions for proof of age cut-off.</span>
          </div>
        </div>
        <div class="flex items-start gap-3">
          <span class="material-symbols-outlined text-secondary text-[22px] mt-0.5">task_alt</span>
          <div class="text-body-sm">
            <span class="font-bold text-primary block">Aadhaar Card (Student &amp; Both Parents)</span>
            <span class="text-on-surface-variant">Clear photocopy for Haryana Parivar Pehchan Patra (PPP) linkage.</span>
          </div>
        </div>
        <div class="flex items-start gap-3">
          <span class="material-symbols-outlined text-secondary text-[22px] mt-0.5">task_alt</span>
          <div class="text-body-sm">
            <span class="font-bold text-primary block">Recent Passport-Size Photographs</span>
            <span class="text-on-surface-variant">4 copies of student and 2 joint photos with mother and father.</span>
          </div>
        </div>
        <div class="flex items-start gap-3">
          <span class="material-symbols-outlined text-secondary text-[22px] mt-0.5">task_alt</span>
          <div class="text-body-sm">
            <span class="font-bold text-primary block">Caste / Category Certificate (If Applicable)</span>
            <span class="text-on-surface-variant">SC/ST/OBC/EWS certificate issued by competent Tehsildar or SDM authority.</span>
          </div>
        </div>
      </div>
      ...
      <div class="p-6 bg-surface-cream rounded-xl shadow-sm flex items-center justify-between">
        <div>
          <h4 class="font-headline-sm text-headline-sm text-primary">Prefer an In-Person Campus Tour?</h4>
          <p class="font-body-sm text-body-sm text-on-surface-variant mt-0.5">Visit Dobhi campus Monday to Saturday between 9:00 AM – 2:30 PM.</p>
        </div>
        <button class="bg-primary hover:bg-[#C9A24B] hover:text-primary text-on-primary px-4 py-2.5 rounded-lg text-label-sm font-bold transition-all shrink-0">
          Book Visit
        </button>
      </div>
    </div>
    ...
    <div class="lg:col-span-7 flex flex-col gap-4">
      ...
      <div class="faq-accordion-item bg-surface-pure rounded-xl p-5 shadow-sm transition-all">
        <button class="faq-trigger w-full flex items-center justify-between text-left font-headline-sm text-headline-sm text-primary">
          <span>What happens immediately after paying the admission checkout fee?</span>
        ...
        <div class="faq-content mt-3 text-body-md text-on-surface-variant">
          You will receive an automated SMS and WhatsApp confirmation containing the provisional Student Enrolment ID, downloadable fee receipt PDF, and scheduled date for the baseline interaction/diagnostic test at Sun Rise Sr. Sec. School, Dobhi.
        </div>
      </div>
      ...
      <div class="faq-accordion-item bg-surface-pure rounded-xl p-5 shadow-sm transition-all">
        <button class="faq-trigger w-full flex items-center justify-between text-left font-headline-sm text-headline-sm text-primary">
          <span>Can we pay the monthly tuition fee easily online or at school?</span>
          <span class="material-symbols-outlined text-secondary transition-transform faq-arrow">expand_more</span>
        </button>
        <div class="faq-content mt-3 text-body-md text-on-surface-variant">
          Yes. Monthly tuition fees (around ₹600 to ₹1,000 / month) can be paid through UPI QR, net banking, debit/credit cards, or directly at the school cash counter by the 10th of every month.
        </div>
      </div>
      ...
      <div class="faq-accordion-item bg-surface-pure rounded-xl p-5 shadow-sm transition-all">
        <button class="faq-trigger w-full flex items-center justify-between text-left font-headline-sm text-headline-sm text-primary">
          <span>How are Science/Commerce streams allocated in Class 11?</span>
          <span class="material-symbols-outlined text-secondary transition-transform faq-arrow">expand_more</span>
        </button>
        <div class="faq-content mt-3 text-body-md text-on-surface-variant">
          Science (Medical &amp; Non-Medical) stream requires an aggregate minimum of 60% in Class 10 Board examinations with strong interest in Science &amp; Mathematics. Commerce and Humanities are allotted based on student preference and aptitude evaluation.
        </div>
      </div>
      ...
      <div class="faq-accordion-item bg-surface-pure rounded-xl p-5 shadow-sm transition-all">
        <button class="faq-trigger w-full flex items-center justify-between text-left font-headline-sm text-headline-sm text-primary">
          <span>Which villages are covered under the Dobhi bus transit network?</span>
          <span class="material-symbols-outlined text-secondary transition-transform faq-arrow">expand_more</span>
        </button>
        <div class="faq-content mt-3 text-body-md text-on-surface-variant">
          Our GPS-enabled bus network covers: Dobhi, Balsamand, Arya Nagar, Rawalwas Kalan, Rawalwas Khurd, Bandaheri, Chaudhariwas, Muklan, Mirzapur, and major rural arterial stops within a 22 km radius. Female attendants accompany all pre-primary and junior bus routes.
        </div>
      </div>
      ...
      <div class="faq-accordion-item bg-surface-pure rounded-xl p-5 shadow-sm transition-all">
        <button class="faq-trigger w-full flex items-center justify-between text-left font-headline-sm text-headline-sm text-primary">
          <span>Is the registration fee refundable if we decide to withdraw?</span>
          <span class="material-symbols-outlined text-secondary transition-transform faq-arrow">expand_more</span>
        </button>
        <div class="faq-content mt-3 text-body-md text-on-surface-variant">
          If the student does not qualify in the assessment test or if a transfer posting is documented prior to April 1st, all deposited advance tuition fees and security deposits are 100% refundable without deductions. The application prospectus fee (₹200) covers processing administrative overheads.
        </div>
      </div>
    </div>
  </div>
...
<script>
    (function() {
      ...
      function calculateTotal() {
        ...
        const tokenTotal = state.regFee + 200;
