...
<div class="flex flex-col w-full">
  ...
  <section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12 -mt-6 sm:-mt-8 relative z-20 w-full">
    <div class="grid grid-cols-2 md:grid-cols-4 gap-2 sm:gap-4 bg-primary text-on-primary rounded-xl py-4 sm:py-5 px-4 sm:px-6 shadow-xl border border-white/10">
      <div class="flex flex-col items-center text-center p-2">
        <span class="text-lg sm:text-xl md:text-2xl font-headline-lg font-bold text-[#C9A24B] tracking-tight"><?= get_text('campus', 'stat1_num', '5+ Acres') ?></span>
        <span class="text-[11px] sm:text-xs font-medium text-white/90 mt-0.5"><?= get_text('campus', 'stat1_lbl', 'Sprawling Green Campus') ?></span>
      </div>
      <div class="flex flex-col items-center text-center p-2 border-l border-white/15">
        <span class="text-lg sm:text-xl md:text-2xl font-headline-lg font-bold text-[#C9A24B] tracking-tight"><?= get_text('campus', 'stat2_num', '30+') ?></span>
        <span class="text-[11px] sm:text-xs font-medium text-white/90 mt-0.5"><?= get_text('campus', 'stat2_lbl', 'Smart Tech Classrooms') ?></span>
      </div>
      <div class="flex flex-col items-center text-center p-2 border-l md:border-white/15">
        <span class="text-lg sm:text-xl md:text-2xl font-headline-lg font-bold text-[#C9A24B] tracking-tight"><?= get_text('campus', 'stat3_num', '35+') ?></span>
        <span class="text-[11px] sm:text-xs font-medium text-white/90 mt-0.5"><?= get_text('campus', 'stat3_lbl', 'Villages Bus Transit Network') ?></span>
      </div>
      <div class="flex flex-col items-center text-center p-2 border-l border-white/15">
        <span class="text-lg sm:text-xl md:text-2xl font-headline-lg font-bold text-[#C9A24B] tracking-tight"><?= get_text('campus', 'stat4_num', '100%') ?></span>
        <span class="text-[11px] sm:text-xs font-medium text-white/90 mt-0.5"><?= get_text('campus', 'stat4_lbl', 'CCTV & Campus Perimeter Monitored') ?></span>
      </div>
    </div>
  </section>

  <!-- Facilities Directory Section -->
  <section class="max-w-7xl mx-auto px-6 lg:px-12 py-10 sm:py-12 lg:py-14" id="facilities-grid">
    <div class="flex flex-col md:flex-row justify-between items-start md:items-end mb-6 sm:mb-8 gap-4 sm:gap-6">
      <div>
        ...
        <h2 class="text-[1.1rem] sm:text-[1.2rem] font-headline-lg font-bold text-primary tracking-tight leading-snug mt-1.5"><?= get_text('campus', 'facilities_heading', 'Facilities for Holistic Growth') ?></h2>
      </div>
    ...
    <!-- Category Filter Bar -->
    <div class="flex flex-wrap items-center gap-2 mb-6 sm:mb-8 pb-1">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      ...
      <div class="campus-card bg-white rounded-xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 border border-border-warm flex flex-col group cursor-pointer" data-category="academics" id="classrooms" onclick="openLightbox(this)">
        ...
        <div class="p-5 sm:p-6 flex flex-col flex-1 justify-between gap-3 sm:gap-4">
          <div class="flex flex-col gap-1.5">
            <span class="text-eyebrow text-[#C9A24B] uppercase font-bold text-[11px]"><?= get_text('campus', 'fac1_tag', '30+ Classrooms') ?></span>
            <h3 class="font-headline-sm text-base sm:text-lg font-bold text-primary group-hover:text-[#C9A24B] transition-colors"><?= get_text('campus', 'fac1_title', 'Smart Classrooms') ?></h3>
          ...
          <div class="pt-3 border-t border-border-warm flex items-center justify-between mt-auto">
            <span class="text-xs font-semibold text-on-surface-variant truncate mr-2"><?= get_text('campus', 'fac1_feature', 'Interactive AV Learning') ?></span>
      ...
      <div class="campus-card bg-white rounded-xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 border border-border-warm flex flex-col group cursor-pointer" data-category="academics" id="labs" onclick="openLightbox(this)">
        ...
        <div class="p-5 sm:p-6 flex flex-col flex-1 justify-between gap-3 sm:gap-4">
          <div class="flex flex-col gap-1.5">
            <span class="text-eyebrow text-[#C9A24B] uppercase font-bold text-[11px]"><?= get_text('campus', 'fac2_tag', 'Hands-On Discovery') ?></span>
            <h3 class="font-headline-sm text-base sm:text-lg font-bold text-primary group-hover:text-[#C9A24B] transition-colors"><?= get_text('campus', 'fac2_title', 'Composite Science Labs') ?></h3>
            <p class="text-body-md text-on-surface-variant text-xs sm:text-sm line-clamp-2 leading-relaxed mt-0.5">
          ...
          <div class="pt-3 border-t border-border-warm flex items-center justify-between mt-auto">
            <span class="text-xs font-semibold text-on-surface-variant truncate mr-2"><?= get_text('campus', 'fac2_feature', 'Physics, Chem & Bio') ?></span>
            <span class="inline-flex items-center gap-1 text-xs font-bold text-primary group-hover:text-[#C9A24B] transition-colors shrink-0">
              Read More <span class="material-symbols-outlined text-[15px] group-hover:translate-x-1 transition-transform">arrow_forward</span>
            </span>
          </div>
      ...
      <div class="campus-card bg-white rounded-xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 border border-border-warm flex flex-col group cursor-pointer" data-category="academics" id="computer-lab" onclick="openLightbox(this)">
        ...
        <div class="p-5 sm:p-6 flex flex-col flex-1 justify-between gap-3 sm:gap-4">
          <div class="flex flex-col gap-1.5">
            <span class="text-eyebrow text-[#C9A24B] uppercase font-bold text-[11px]"><?= get_text('campus', 'fac_comp_tag', 'Digital Education') ?></span>
            <h3 class="font-headline-sm text-base sm:text-lg font-bold text-primary group-hover:text-[#C9A24B] transition-colors"><?= get_text('campus', 'fac_comp_title', 'Modern Computer Lab') ?></h3>
            <p class="text-body-md text-on-surface-variant text-xs sm:text-sm line-clamp-2 leading-relaxed mt-0.5">
          ...
          <div class="pt-3 border-t border-border-warm flex items-center justify-between mt-auto">
            <span class="text-xs font-semibold text-on-surface-variant truncate mr-2"><?= get_text('campus', 'fac_comp_feature', 'IT & Digital Literacy') ?></span>
            <span class="inline-flex items-center gap-1 text-xs font-bold text-primary group-hover:text-[#C9A24B] transition-colors shrink-0">
              Read More <span class="material-symbols-outlined text-[15px] group-hover:translate-x-1 transition-transform">arrow_forward</span>
            </span>
          </div>
      ...
      <div class="campus-card bg-white rounded-xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 border border-border-warm flex flex-col group cursor-pointer" data-category="academics" id="library" onclick="openLightbox(this)">
        ...
        <div class="p-5 sm:p-6 flex flex-col flex-1 justify-between gap-3 sm:gap-4">
          <div class="flex flex-col gap-1.5">
            <span class="text-eyebrow text-[#C9A24B] uppercase font-bold text-[11px]"><?= get_text('campus', 'fac_lib_tag', 'Resource Center') ?></span>
            <h3 class="font-headline-sm text-base sm:text-lg font-bold text-primary group-hover:text-[#C9A24B] transition-colors"><?= get_text('campus', 'fac_lib_title', 'School Library & Reading Room') ?></h3>
            <p class="text-body-md text-on-surface-variant text-xs sm:text-sm line-clamp-2 leading-relaxed mt-0.5">
          ...
          <div class="pt-3 border-t border-border-warm flex items-center justify-between mt-auto">
            <span class="text-xs font-semibold text-on-surface-variant truncate mr-2"><?= get_text('campus', 'fac_lib_feature', 'Enriched Reading Repository') ?></span>
            <span class="inline-flex items-center gap-1 text-xs font-bold text-primary group-hover:text-[#C9A24B] transition-colors shrink-0">
              Read More <span class="material-symbols-outlined text-[15px] group-hover:translate-x-1 transition-transform">arrow_forward</span>
            </span>
          </div>
      ...
      <div class="campus-card bg-white rounded-xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 border border-border-warm flex flex-col group cursor-pointer" data-category="sports" id="sports" onclick="openLightbox(this)">
        ...
        <div class="p-5 sm:p-6 flex flex-col flex-1 justify-between gap-3 sm:gap-4">
          <div class="flex flex-col gap-1.5">
            <span class="text-eyebrow text-[#C9A24B] uppercase font-bold text-[11px]"><?= get_text('campus', 'fac3_tag', 'Sports & Fitness') ?></span>
            <h3 class="font-headline-sm text-base sm:text-lg font-bold text-primary group-hover:text-[#C9A24B] transition-colors"><?= get_text('campus', 'fac3_title', 'Expansive Sports Ground') ?></h3>
            <p class="text-body-md text-on-surface-variant text-xs sm:text-sm line-clamp-2 leading-relaxed mt-0.5">
          ...
          <div class="pt-3 border-t border-border-warm flex items-center justify-between mt-auto">
            <span class="text-xs font-semibold text-on-surface-variant truncate mr-2"><?= get_text('campus', 'fac3_feature', 'Athletics & Games') ?></span>
            <span class="inline-flex items-center gap-1 text-xs font-bold text-primary group-hover:text-[#C9A24B] transition-colors shrink-0">
              Read More <span class="material-symbols-outlined text-[15px] group-hover:translate-x-1 transition-transform">arrow_forward</span>
            </span>
          </div>
      ...
      <div class="campus-card bg-white rounded-xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 border border-border-warm flex flex-col group cursor-pointer" data-category="sports" id="yoga" onclick="openLightbox(this)">
        ...
        <div class="p-5 sm:p-6 flex flex-col flex-1 justify-between gap-3 sm:gap-4">
          <div class="flex flex-col gap-1.5">
            <span class="text-eyebrow text-[#C9A24B] uppercase font-bold text-[11px]"><?= get_text('campus', 'fac4_tag', 'Mind & Body') ?></span>
            <h3 class="font-headline-sm text-base sm:text-lg font-bold text-primary group-hover:text-[#C9A24B] transition-colors"><?= get_text('campus', 'fac4_title', 'Yoga & Meditation Arena') ?></h3>
            <p class="text-body-md text-on-surface-variant text-xs sm:text-sm line-clamp-2 leading-relaxed mt-0.5">
          ...
          <div class="pt-3 border-t border-border-warm flex items-center justify-between mt-auto">
            <span class="text-xs font-semibold text-on-surface-variant truncate mr-2"><?= get_text('campus', 'fac4_feature', 'Daily Mindfulness & Asanas') ?></span>
            <span class="inline-flex items-center gap-1 text-xs font-bold text-primary group-hover:text-[#C9A24B] transition-colors shrink-0">
              Read More <span class="material-symbols-outlined text-[15px] group-hover:translate-x-1 transition-transform">arrow_forward</span>
            </span>
          </div>
      ...
      <div class="campus-card bg-white rounded-xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 border border-border-warm flex flex-col group cursor-pointer" data-category="community" id="exhibition" onclick="openLightbox(this)">
        ...
        <div class="p-5 sm:p-6 flex flex-col flex-1 justify-between gap-3 sm:gap-4">
          <div class="flex flex-col gap-1.5">
            <span class="text-eyebrow text-[#C9A24B] uppercase font-bold text-[11px]"><?= get_text('campus', 'fac5_tag', 'Creative Expression') ?></span>
            <h3 class="font-headline-sm text-base sm:text-lg font-bold text-primary group-hover:text-[#C9A24B] transition-colors"><?= get_text('campus', 'fac5_title', 'Exhibition & Project Hall') ?></h3>
            <p class="text-body-md text-on-surface-variant text-xs sm:text-sm line-clamp-2 leading-relaxed mt-0.5">
          ...
          <div class="pt-3 border-t border-border-warm flex items-center justify-between mt-auto">
            <span class="text-xs font-semibold text-on-surface-variant truncate mr-2"><?= get_text('campus', 'fac5_feature', 'Science Fairs & Art Displays') ?></span>
            <span class="inline-flex items-center gap-1 text-xs font-bold text-primary group-hover:text-[#C9A24B] transition-colors shrink-0">
              Read More <span class="material-symbols-outlined text-[15px] group-hover:translate-x-1 transition-transform">arrow_forward</span>
            </span>
          </div>
      ...
      <div class="campus-card bg-white rounded-xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 border border-border-warm flex flex-col group cursor-pointer" data-category="community" id="assembly" onclick="openLightbox(this)">
        ...
        <div class="p-5 sm:p-6 flex flex-col flex-1 justify-between gap-3 sm:gap-4">
          <div class="flex flex-col gap-1.5">
            <span class="text-eyebrow text-[#C9A24B] uppercase font-bold text-[11px]"><?= get_text('campus', 'fac6_tag', 'Character & Values') ?></span>
            <h3 class="font-headline-sm text-base sm:text-lg font-bold text-primary group-hover:text-[#C9A24B] transition-colors"><?= get_text('campus', 'fac6_title', 'Morning Assembly Courtyard') ?></h3>
            <p class="text-body-md text-on-surface-variant text-xs sm:text-sm line-clamp-2 leading-relaxed mt-0.5">
          ...
          <div class="pt-3 border-t border-border-warm flex items-center justify-between mt-auto">
            <span class="text-xs font-semibold text-on-surface-variant truncate mr-2"><?= get_text('campus', 'fac6_feature', 'Daily Moral Assembly') ?></span>
            <span class="inline-flex items-center gap-1 text-xs font-bold text-primary group-hover:text-[#C9A24B] transition-colors shrink-0">
              Read More <span class="material-symbols-outlined text-[15px] group-hover:translate-x-1 transition-transform">arrow_forward</span>
            </span>
          </div>
      ...
      <div class="bg-white rounded-xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 border border-border-warm flex flex-col group md:col-span-2 lg:col-span-3" id="safety">
        <div class="grid grid-cols-1 md:grid-cols-2">
          <div class="relative h-52 md:h-auto overflow-hidden cursor-pointer" onclick="openLightbox(this)">
          ...
          <div class="p-5 sm:p-6 lg:p-8 flex flex-col justify-between gap-4 bg-surface-container-low">
            <div class="flex flex-col gap-2">
              <span class="text-eyebrow text-[#C9A24B] uppercase font-bold text-[11px]"><?= get_text('campus', 'safety_tag', 'Comprehensive Security') ?></span>
              <h3 class="font-headline-md text-lg sm:text-xl font-bold text-primary"><?= get_text('campus', 'safety_title', 'CCTV Security & Campus Safety') ?></h3>
              <p class="text-xs sm:text-sm text-on-surface-variant line-clamp-2 leading-relaxed mt-0.5">
              ...
              <div class="grid grid-cols-2 sm:grid-cols-4 gap-3 mt-2">
                <div class="flex items-center gap-1.5">
                  <span class="material-symbols-outlined text-[#C9A24B] text-[18px]">videocam</span>
                  <span class="text-xs font-bold text-primary"><?= get_text('campus', 'safety_feat1', '24/7 CCTV Cameras') ?></span>
                </div>
                <div class="flex items-center gap-1.5">
                  <span class="material-symbols-outlined text-[#C9A24B] text-[18px]">shield</span>
                  <span class="text-xs font-bold text-primary"><?= get_text('campus', 'safety_feat2', 'Boundary Enclosure') ?></span>
                </div>
                <div class="flex items-center gap-1.5">
                  <span class="material-symbols-outlined text-[#C9A24B] text-[18px]">water_drop</span>
                  <span class="text-xs font-bold text-primary"><?= get_text('campus', 'safety_feat3', 'RO Pure Water') ?></span>
                </div>
                <div class="flex items-center gap-1.5">
                  <span class="material-symbols-outlined text-[#C9A24B] text-[18px]">medical_services</span>
                  <span class="text-xs font-bold text-primary"><?= get_text('campus', 'safety_feat4', 'PHC Proximity') ?></span>
                </div>
              </div>
            </div>
            <div class="pt-4 border-t border-border-warm flex items-center justify-between">
              <span class="text-xs font-bold text-primary"><?= get_text('campus', 'safety_badge_text', 'Peace of Mind for Parents') ?></span>
              <a class="btn-primary py-2 px-4 text-xs font-bold" href="<?= htmlspecialchars(get_text('campus', 'safety_btn_link', 'contact-us.php')) ?>">
  ...
  <section class="max-w-7xl mx-auto px-6 lg:px-12 mb-12 sm:mb-16">
    <div class="bg-primary text-on-primary rounded-2xl p-8 sm:p-10 lg:p-12 relative overflow-hidden flex flex-col lg:flex-row items-center justify-between gap-6">
      ...
      <div class="relative z-10 flex flex-col gap-2.5 max-w-2xl text-center lg:text-left">
        <span class="text-eyebrow text-[#C9A24B] uppercase font-bold text-xs"><?= get_text('campus', 'cta_eyebrow', 'Experience Sun Rise School') ?></span>
        ...
        <p class="text-xs sm:text-sm text-surface-cream/90 leading-relaxed">
