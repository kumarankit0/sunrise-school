      ...
      <div class="footer-grid">
        ...
        <div class="footer-col">
          ...
          <div class="footer-contact-list">
            ...
            <!-- Social Media Channels (Configured via Admin Dashboard) -->
            <div class="footer-social-section">
              <span class="footer-social-label"><?= htmlspecialchars(get_text('general', 'footer_social_heading', 'Follow & Connect:')) ?></span>
              <div class="footer-social-icons">
                ...
                <?php if (!empty($social_twitter)): ?>
                  <a href="<?= htmlspecialchars($social_twitter) ?>" target="_blank" rel="noopener noreferrer" class="footer-social-btn social-twitter" title="Follow us on X (Twitter)" aria-label="Twitter">
