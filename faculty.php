...
<div class="flex flex-col w-full bg-surface">
  ...
  <section class="relative w-full min-h-[80vh] lg:min-h-[85vh] py-20 lg:py-28 bg-primary text-on-primary px-6 lg:px-12 overflow-hidden flex flex-col justify-center items-center text-center">
    <div class="absolute inset-0 opacity-65 bg-cover bg-center pointer-events-none" style="background-image: url('<?= school_img('teachers_and_students.webp') ?>')"></div>
    ...
    <div class="relative z-10 max-w-6xl w-full mx-auto flex flex-col items-center gap-6">
      <span class="px-5 py-2 rounded-full bg-black/40 text-gold-light text-eyebrow uppercase font-bold tracking-widest border border-[#C9A24B]/50 shadow-md">Dedicated Educators</span>
      <h1 class="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-headline-lg text-white w-full max-w-5xl tracking-tight leading-[1.15] drop-shadow-md">Our Distinguished Faculty &amp; Staff</h1>
      <p class="text-lg sm:text-xl md:text-2xl text-surface-cream/95 w-full max-w-4xl font-body leading-relaxed drop-shadow">Meet the passionate educators, experienced subject mentors, and visionary leadership shaping young minds at Sun Rise Sr. Sec. School, Dobhi.</p>
    </div>
  </section>
  ...
  <section class="max-w-7xl mx-auto px-6 lg:px-12 py-24 w-full">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
      ...
      <div class="bg-surface-pure rounded-xl p-8 shadow-[0_2px_8px_rgba(11,38,71,0.04)] hover:shadow-[0_12px_28px_rgba(11,38,71,0.08)] transition-all duration-300 flex flex-col justify-between border border-border-warm relative group">
        ...
        <div>
          <div class="relative w-full h-72 mb-6 rounded-lg overflow-hidden bg-surface-container cursor-pointer" onclick="openLightbox(this)">
            <img class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" alt="School Management & Leadership" src="<?= school_img('speaker.webp') ?>" width="400" height="288" loading="lazy" decoding="async"/>
          ...
          <h3 class="font-headline-sm text-headline-sm text-primary">Managing Committee</h3>
          <p class="text-label-md text-[#B38C37] font-semibold mb-4">Sun Rise Educational Trust, Dobhi</p>
          <blockquote class="text-body-md italic text-on-surface-variant mb-6 font-headline-md border-l-2 border-[#C9A24B] pl-4">
            “True education is the bedrock of character, empowering students to rise above ordinary standards and achieve extraordinary goals.”
          </blockquote>
          <p class="text-body-sm text-on-surface-variant">Providing strategic guidance, modern educational infrastructure, and a community-first commitment to quality education in rural and semi-urban Haryana.</p>
        </div>
      ...
      <div class="bg-surface-pure rounded-xl p-8 shadow-[0_2px_8px_rgba(11,38,71,0.04)] hover:shadow-[0_12px_28px_rgba(11,38,71,0.08)] transition-all duration-300 flex flex-col justify-between border border-border-warm relative group">
        ...
        <div>
          <div class="relative w-full h-72 mb-6 rounded-lg overflow-hidden bg-surface-container cursor-pointer" onclick="openLightbox(this)">
            <img class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" alt="Principal, Sun Rise School" src="<?= school_img('teachers_sitting.webp') ?>" width="400" height="288" loading="lazy" decoding="async"/>
          ...
          <h3 class="font-headline-sm text-headline-sm text-primary">Office of the Principal</h3>
          <p class="text-label-md text-[#B38C37] font-semibold mb-4">M.A., M.Ed. – Senior Academician</p>
          <blockquote class="text-body-md italic text-on-surface-variant mb-6 font-headline-md border-l-2 border-[#C9A24B] pl-4">
            “We cultivate an environment where discipline meets curiosity, ensuring every child discovers their inner spark and thrives academically.”
          </blockquote>
          <p class="text-body-sm text-on-surface-variant">Championing NEP 2020-aligned experiential learning, state-level competitive exam coaching, and holistic sports and cultural development.</p>
        </div>
        <div class="mt-8 pt-6 border-t border-border-warm flex items-center justify-between">
      ...
      <div class="bg-surface-pure rounded-xl p-8 shadow-[0_2px_8px_rgba(11,38,71,0.04)] hover:shadow-[0_12px_28px_rgba(11,38,71,0.08)] transition-all duration-300 flex flex-col justify-between border border-border-warm relative group">
        ...
        <div>
          <div class="relative w-full h-72 mb-6 rounded-lg overflow-hidden bg-surface-container cursor-pointer" onclick="openLightbox(this)">
            <img class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" alt="Academic Coordinators & Faculty" src="<?= school_img('all_staffmembers.webp') ?>" width="400" height="288" loading="lazy" decoding="async"/>
          ...
          <h3 class="font-headline-sm text-headline-sm text-primary">Senior Coordinators</h3>
          <p class="text-label-md text-[#B38C37] font-semibold mb-4">Post Graduate Teachers (PGT / TGT)</p>
          <blockquote class="text-body-md italic text-on-surface-variant mb-6 font-headline-md border-l-2 border-[#C9A24B] pl-4">
            “Teamwork, continuous faculty workshops, and individualized student attention form the backbone of our outstanding board results.”
          </blockquote>
          <p class="text-body-sm text-on-surface-variant">Coordinating Science, Commerce, and Arts streams with rigorous periodic assessments and personalized student counseling.</p>
        </div>
        <div class="mt-8 pt-6 border-t border-border-warm flex items-center justify-between">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div class="bg-surface-pure rounded-xl overflow-hidden border border-border-warm shadow-sm hover:shadow-lg transition-all group cursor-pointer" onclick="openLightbox(this)">
          <div class="relative h-64 overflow-hidden">
            <img class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" alt="All Staff Members - Sun Rise School" src="<?= school_img('all_staffmembers.webp') ?>" width="400" height="256" loading="lazy" decoding="async"/>
            ...
            <div class="absolute bottom-4 left-4 right-4 text-white">
              ...
              <h4 class="font-headline-sm text-sm text-white">Sun Rise Teaching &amp; Admin Staff</h4>
            </div>
          </div>
        </div>
        ...
        <div class="bg-surface-pure rounded-xl overflow-hidden border border-border-warm shadow-sm hover:shadow-lg transition-all group cursor-pointer" onclick="openLightbox(this)">
          <div class="relative h-64 overflow-hidden">
            <img class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" alt="Teachers and Students - Sun Rise School" src="<?= school_img('teachers_and_students.webp') ?>" width="400" height="256" loading="lazy" decoding="async"/>
            <div class="absolute inset-0 bg-gradient-to-t from-primary/80 via-transparent to-transparent opacity-80 group-hover:opacity-90 transition-opacity"></div>
            <div class="absolute bottom-4 left-4 right-4 text-white">
              <span class="text-[11px] font-bold uppercase bg-[#C9A24B] text-primary px-2.5 py-0.5 rounded inline-block mb-1">Mentorship</span>
              <h4 class="font-headline-sm text-sm text-white">Faculty &amp; High Achievers</h4>
            </div>
          </div>
        </div>
        ...
        <div class="bg-surface-pure rounded-xl overflow-hidden border border-border-warm shadow-sm hover:shadow-lg transition-all group cursor-pointer" onclick="openLightbox(this)">
          <div class="relative h-64 overflow-hidden">
            <img class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" alt="Teachers Meeting - Sun Rise School" src="<?= school_img('teachers_sitting.webp') ?>" width="400" height="256" loading="lazy" decoding="async"/>
            <div class="absolute inset-0 bg-gradient-to-t from-primary/80 via-transparent to-transparent opacity-80 group-hover:opacity-90 transition-opacity"></div>
            <div class="absolute bottom-4 left-4 right-4 text-white">
              ...
              <h4 class="font-headline-sm text-sm text-white">Faculty Planning &amp; Review</h4>
            </div>
          </div>
        </div>
        ...
        <div class="bg-surface-pure rounded-xl overflow-hidden border border-border-warm shadow-sm hover:shadow-lg transition-all group cursor-pointer" onclick="openLightbox(this)">
          <div class="relative h-64 overflow-hidden">
            <img class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" alt="School Staff Members" src="<?= school_img('school_staff.webp') ?>" width="400" height="256" loading="lazy" decoding="async"/>
            <div class="absolute inset-0 bg-gradient-to-t from-primary/80 via-transparent to-transparent opacity-80 group-hover:opacity-90 transition-opacity"></div>
            <div class="absolute bottom-4 left-4 right-4 text-white">
              <span class="text-[11px] font-bold uppercase bg-[#C9A24B] text-primary px-2.5 py-0.5 rounded inline-block mb-1">Staff Team</span>
              <h4 class="font-headline-sm text-sm text-white">Department Educators</h4>
            </div>
          </div>
        </div>
        ...
        <div class="bg-surface-pure rounded-xl overflow-hidden border border-border-warm shadow-sm hover:shadow-lg transition-all group cursor-pointer" onclick="openLightbox(this)">
          <div class="relative h-64 overflow-hidden">
            <img class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" alt="Teachers Panel" src="<?= school_img('teachers.webp') ?>" width="400" height="256" loading="lazy" decoding="async"/>
            <div class="absolute inset-0 bg-gradient-to-t from-primary/80 via-transparent to-transparent opacity-80 group-hover:opacity-90 transition-opacity"></div>
            <div class="absolute bottom-4 left-4 right-4 text-white">
              <span class="text-[11px] font-bold uppercase bg-[#C9A24B] text-primary px-2.5 py-0.5 rounded inline-block mb-1">Pedagogy</span>
              <h4 class="font-headline-sm text-sm text-white">Senior School Mentors</h4>
            </div>
          </div>
        </div>
        ...
        <div class="bg-surface-pure rounded-xl overflow-hidden border border-border-warm shadow-sm hover:shadow-lg transition-all group cursor-pointer" onclick="openLightbox(this)">
          <div class="relative h-64 overflow-hidden">
            <img class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" alt="Students with Teachers" src="<?= school_img('students_teachers.webp') ?>" width="400" height="256" loading="lazy" decoding="async"/>
            <div class="absolute inset-0 bg-gradient-to-t from-primary/80 via-transparent to-transparent opacity-80 group-hover:opacity-90 transition-opacity"></div>
            <div class="absolute bottom-4 left-4 right-4 text-white">
              <span class="text-[11px] font-bold uppercase bg-[#C9A24B] text-primary px-2.5 py-0.5 rounded inline-block mb-1">Campus Life</span>
              <h4 class="font-headline-sm text-sm text-white">Student &amp; Mentor Bonding</h4>
            </div>
          </div>
        </div>
      </div>
  ...
  <section class="bg-primary text-on-primary py-16 px-6 lg:px-12">
    <div class="max-w-5xl mx-auto flex flex-col md:flex-row items-center justify-between gap-8 text-center md:text-left">
      <div class="flex flex-col gap-2">
        <span class="text-eyebrow text-[#C9A24B] uppercase font-bold">Career Opportunities</span>
        <h3 class="text-headline-md font-bold">Want to Join Our Teaching Team?</h3>
        <p class="text-body-md text-on-primary-container max-w-xl">We are always looking for passionate, certified educators who love teaching and inspiring students. Send us your resume.</p>
      </div>
