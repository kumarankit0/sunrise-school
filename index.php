...
<div class="flex flex-col w-full">
  ...
  <section class="relative w-full min-h-[80vh] lg:min-h-[85vh] py-20 lg:py-28 flex items-center justify-center overflow-hidden bg-primary">
    <div class="absolute inset-0 z-0 opacity-65 bg-cover bg-center transition-all duration-1000" style="background-image: url('<?= get_image('home', 'hero_banner', school_img('school_home1.webp')) ?>')"></div>
      ...
      <div class="lg:col-span-6 grid grid-cols-2 gap-3 sm:gap-6">
        <div class="flex flex-col gap-3 sm:gap-6">
          <div class="p-4 sm:p-6 lg:p-8 bg-primary text-on-primary rounded-xl flex flex-col justify-between min-h-[140px] sm:h-56 lg:h-64 shadow-sm">
            ...
            <div>
              <div class="text-xl sm:text-2xl lg:text-4xl font-headline-lg font-bold text-[#C9A24B]"><?= get_text('home', 'stat_years_service', '20+') ?></div>
          ...
          <div class="p-4 sm:p-6 lg:p-8 bg-surface-container-low rounded-xl border border-border-warm flex flex-col justify-between min-h-[140px] sm:h-56 lg:h-64 shadow-sm">
            ...
            <div>
              <div class="text-xl sm:text-2xl lg:text-4xl font-headline-lg font-bold text-primary"><?= get_text('home', 'stat_enrolled_scholars', '1,500+') ?></div>
        ...
        <div class="flex flex-col gap-3 sm:gap-6 pt-3 sm:pt-6 lg:pt-12">
          ...
          <div class="p-4 sm:p-6 lg:p-8 bg-[#C9A24B] text-primary rounded-xl flex flex-col justify-between min-h-[140px] sm:h-56 lg:h-64 shadow-sm">
            ...
            <div>
              <div class="text-xl sm:text-2xl lg:text-4xl font-headline-lg font-bold text-primary"><?= get_text('home', 'stat_dedicated_staff', '50+') ?></div>
  ...
  <section class="w-full py-24 bg-surface-container-low">
    <div class="max-w-7xl mx-auto px-6 lg:px-12 flex flex-col gap-16">
      <div class="flex flex-col md:flex-row md:items-end justify-between gap-6">
        <div>
          <div class="text-eyebrow text-[#C9A24B] uppercase tracking-widest"><?= get_text('home', 'pillars_eyebrow', 'WHY CHOOSE SUN RISE') ?></div>
          <h2 class="text-headline-lg-mobile md:text-headline-lg font-headline-lg text-primary mt-2"><?= get_text('home', 'pillars_heading', 'Pillars of Holistic Development') ?></h2>
        </div>
        <p class="text-body-md text-on-surface-variant max-w-md"><?= get_text('home', 'pillars_desc', 'Our balanced framework ensures intellectual achievement is complemented by discipline, sportsmanship, and creative expression.') ?></p>
      </div>
  ...
  <section class="w-full py-24 bg-surface relative">
    <div class="max-w-7xl mx-auto px-6 lg:px-12 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
      ...
      <div class="lg:col-span-7 flex flex-col gap-6 lg:pl-10">
        <div class="text-eyebrow text-[#C9A24B] uppercase tracking-widest"><?= get_text('home', 'leader_tagline', 'LEADERSHIP MESSAGE') ?></div>
  ...
  <section class="w-full py-24 bg-surface-container-low">
    <div class="max-w-7xl mx-auto px-6 lg:px-12 flex flex-col gap-12">
      <div class="flex flex-col md:flex-row md:items-end justify-between gap-6">
        <div>
          <div class="text-eyebrow text-[#C9A24B] uppercase tracking-widest"><?= get_text('home', 'events_eyebrow', 'NOTICES &amp; HAPPENINGS') ?></div>
          <h2 class="text-headline-lg-mobile md:text-headline-lg font-headline-lg text-primary mt-2"><?= get_text('home', 'events_heading', 'School Events &amp; News') ?></h2>
        </div>
  ...
  <section class="w-full py-24 bg-surface relative">
    <div class="max-w-7xl mx-auto px-6 lg:px-12 flex flex-col gap-12">
      <div class="flex flex-col md:flex-row md:items-end justify-between gap-6">
        <div>
          <div class="text-eyebrow text-[#C9A24B] uppercase tracking-widest"><?= get_text('home', 'gallery_eyebrow', 'CAMPUS GLIMPSES') ?></div>
          <h2 class="text-headline-lg-mobile md:text-headline-lg font-headline-lg text-primary mt-2"><?= get_text('home', 'gallery_heading', 'Life at Sun Rise Sr. Sec. School') ?></h2>
        </div>
        <a class="inline-flex items-center gap-2 text-label-md text-primary font-bold hover:text-[#C9A24B] transition-colors" href="gallery.php">
